...
if (isset($_POST['submitted'])) {
	...
	$bulletin_date = $position = $title = $subtitle = $blurb = $excerpt = '';
}
...
?>
<form name="form1" method="post" action="WBEntry.php">
    <p>
    ...
    <p>
        ...
        <textarea name="blurb" id="blurb" cols="70" rows="10"></textarea>
    </p>
    <p>
    ...
    <p>
        ...
        <select name="bulletin_date" id="bulletin_date">
            <option value="20120516">May 16, 2012</option>
            <option value="20120523">May 23, 2012</option>
            <option value="20120530">May 30, 2012</option>
            <option value="20120606">June 6, 2012</option>
        </select>
    </p>
    <p>
