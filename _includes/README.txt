...
Next, you'll need to create a file to allow the scripts to access your database. Edit the provided file _includes/db_info_sample.inc.php and put in the correct values for host, user, password, and database name for your installation. When the file is reay, save it as _includes/db_info.inc.php.
